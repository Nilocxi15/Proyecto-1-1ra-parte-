        ...
        <div class="wrapper">
            ...
            <nav class="navbar bg-body-tertiary fixed-top"
                ...
                <div class="container-fluid">
                    <a class="navbar-brand" href="http://localhost:8080/webAppNew/admins/fee.jsp">Tarifas</a>
            ...
            <div class="tables">
                ...
                <h2 class="tittle">Cuotas de paquetes por libra</h2>

                <div class="d-flex p-2">
                    <div class="container my-4">                                                   
                        <table id="datatable_weight" class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody id="table_weight">
                                <%
                                    DAOweight dao = new DAOweight();
                                    List<weight> List = dao.list();
                                ...
                                %>
                                <tr>
                                    <td class="centered"><%=wgt.getWeight()%> lbs</td>
                                    <td class="centered">Q <%=wgt.getPrice()%></td>
                                </tr>
                                <%}%>
                            </tbody>
                        </table>                                                  
            ...
            <script>
                new DataTable('#datatable_weight', {
                    lengthMenu: [5, 10, 25],
                    language: {
